    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descriptions', models.TextField(default='Описание появиться позже', verbose_name='Описание')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateField(auto_now=True, verbose_name='Дата созданиня заказа')),
                ('order_date', models.DateField(default=datetime.datetime(2021, 8, 28, 14, 40, 7, 672571, tzinfo=utc), verbose_name='Дата получения заказа')),
        ...
        migrations.AddField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicshop.artist', verbose_name='Артист'),
        ),
        migrations.AddField(
            model_name='album',
            name='media_type',
